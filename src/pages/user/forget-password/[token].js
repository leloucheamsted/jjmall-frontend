      ...
      <div className="h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white rounded-lg shadow max-w-md w-full space-y-8 py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold font-serif">{showLogin ? "Login" : "Forget Password"}</h2>
            <p className="text-sm md:text-base text-gray-500 mt-2 mb-8 sm:mb-10">{showLogin ? "Login with your email and new password" : "Reset Your Password"}</p>
          </div>
          <form onSubmit={handleSubmit(submitHandler)} className="flex flex-col justify-center">
            <div className="grid grid-cols-1 gap-5">
                ...
                <>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      className="py-2 px-4 md:px-5 w-full appearance-none border text-sm opacity-75 text-input rounded-md placeholder-body min-h-12 transition duration-200 focus:ring-0 ease-in-out bg-gray-100 border-gray-200 focus:outline-none focus:border-primary h-11 md:h-12"
                    />
              ...
              <button disabled={loading} type="submit" className="w-full text-center py-3 rounded bg-primary font-medium text-sm text-white hover:bg-emerald-600 transition-all focus:outline-none my-1">
