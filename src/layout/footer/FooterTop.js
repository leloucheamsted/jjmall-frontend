...
const FooterTop = () => {
  return (
    // lg:bg-indigo-50
    <div id="downloadApp" className="bg-white py-10 lg:py-10 bg-repeat bg-center overflow-hidden">
      <div className="hidden max-w-screen-2xl mx-auto px-4 sm:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-2 md:gap-3 lg:gap-3 items-center">
          ...
          <div className="text-center ">
            <h3 className="text-xl md:text-2xl lg:text-3xl font-bold font-serif mb-3">
              Get Your Daily Needs From Our JJmall Store
            </h3>
